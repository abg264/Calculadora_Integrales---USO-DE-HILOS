...
class ModernCalculator(QWidget):
    ...
    def update_ui_state(self):
        ...
        # Ahora el índice 0 es el único que usa la lista de Definida/Indefinida
        is_simple = (idx_type == 0)
        ...
        # 0: Sencilla(1 límite), 1: Doble(2), 2: Triple(3), 3: Doble Polar(2)
        num_limits = 0
        if not is_indefinite and not is_basic:
            num_limits = {0: 1, 1: 2, 2: 3, 3: 2}.get(idx_type, 0)
